  ...
  return (
    <div className="min-h-screen bg-slate-50 py-4 sm:py-12 px-4 sm:px-6 lg:px-8 font-sans text-base leading-relaxed">
      <div id="agreement-content" className="max-w-4xl mx-auto bg-white shadow-xl min-h-screen flex flex-col print:shadow-none print:max-w-none">
            ...
            <div className="bg-slate-50 p-3 print:p-2 rounded-xl border border-slate-200 print:border-slate-300 print:rounded-none">
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-2 print:gap-1">
                ...
                <div>
                  ...
                  <p className="text-sm print:text-[9pt] font-medium text-slate-900">{format(new Date(agreement.start_date), 'dd MMM yyyy')} {agreement.pickup_time || '-'}</p>
                </div>
                <div>
                  <p className="text-[10px] print:text-[7pt] font-bold text-slate-500 uppercase tracking-wider">Return Date/Time</p>
                  <p className="text-sm print:text-[9pt] font-medium text-slate-900">{format(new Date(agreement.end_date), 'dd MMM yyyy')} {agreement.return_time || '-'}</p>
                </div>
                <div>
        ...
        <div className="bg-white border-t border-slate-200 print:border-slate-800 p-4 print:p-2 flex justify-center items-center gap-4 mt-8 print:mt-auto print:page-break-inside-avoid print:mb-0">
          {company?.logo_url && (
            <div className="h-12 print:h-10 flex items-center justify-center bg-transparent border-none shadow-none overflow-hidden">
