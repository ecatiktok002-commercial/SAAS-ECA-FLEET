  ...
  return (
    <div className="absolute top-0 left-0 w-0 h-0 overflow-hidden -z-50 pointer-events-none opacity-0">
      <div id="printable-agreement" className="w-[794px] min-w-[794px] max-w-[794px]">
        ...
        <div className="mt-auto pt-8 flex justify-center items-center gap-10 border-t border-gray-200">
          {brandSettings.logoUrl && (
            <div className="h-16 flex items-center justify-center">
              <img src={brandSettings.logoUrl} alt="Company Logo" className="h-full w-auto object-contain" crossOrigin="anonymous" />
            </div>
          )}
          {brandSettings.ssmLogoUrl && (
            <div className="h-16 flex items-center justify-center">
              <img src={brandSettings.ssmLogoUrl} alt="SSM Logo" className="h-full w-auto object-contain" crossOrigin="anonymous" />
            </div>
          )}
          {brandSettings.spdpLogoUrl && (
            <div className="h-16 flex items-center justify-center">
              <img src={brandSettings.spdpLogoUrl} alt="SPDP Logo" className="h-full w-auto object-contain" crossOrigin="anonymous" />
            </div>
          )}
        </div>
