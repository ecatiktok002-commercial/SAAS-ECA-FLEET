          ...
          <div className="flex justify-between w-full items-center px-4">
            <div className="h-16 w-32 flex items-center justify-center">
              {brandSettings.logoUrl ? (
                <img src={brandSettings.logoUrl} alt="Company Logo" className="h-full w-full object-contain" crossOrigin="anonymous" />
              ) : (
                <div className="text-[8px] text-gray-400">COMPANY LOGO</div>
              )}
            </div>
            <div className="h-16 w-32 flex items-center justify-center">
              {brandSettings.ssmLogoUrl ? (
                <img src={brandSettings.ssmLogoUrl} alt="SSM Logo" className="h-full w-full object-contain" crossOrigin="anonymous" />
              ) : (
                <div className="text-[8px] text-gray-400">SSM LOGO</div>
              )}
            </div>
            <div className="h-16 w-32 flex items-center justify-center">
              {brandSettings.spdpLogoUrl ? (
                <img src={brandSettings.spdpLogoUrl} alt="SPDP Logo" className="h-full w-full object-contain" crossOrigin="anonymous" />
              ) : (
                <div className="text-[8px] text-gray-400">SPDP LOGO</div>
              )}
            </div>
          </div>
        </div>
        <div className="text-[8px] text-gray-400 flex justify-between mt-2">
